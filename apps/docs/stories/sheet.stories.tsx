        ...
        <SheetContent onClose={() => setOpen(false)}>
          ...
          <div className="py-4">
            <p className="text-sm text-gray-600">
              Add your content here. Sheets are great for filters, settings, or
              additional information that doesn&apos;t need to interrupt the
              main flow.
            </p>
          </div>
          <SheetFooter>
...
function FromLeftComponent(): JSX.Element {
  const [open, setOpen] = useState(false);
...
export const FromLeft: Story = {
  render: () => <FromLeftComponent />,
};

function FromTopComponent(): JSX.Element {
  const [open, setOpen] = useState(false);
...
export const FromTop: Story = {
  render: () => <FromTopComponent />,
};

function FromBottomComponent(): JSX.Element {
  const [open, setOpen] = useState(false);
